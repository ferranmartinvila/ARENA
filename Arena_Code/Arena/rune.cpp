...
//COSTRUCTOR-------------------------------------
rune::rune(char* name, char* description, uint rune_grade, RUNE_TYPE rune_type, uint enchant_points, uint price) :object(name, description, RUNE, price), rune_grade(rune_grade), rune_type(rune_type), enchant_points(enchant_points){}
